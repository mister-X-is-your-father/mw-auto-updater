...
PHP、Laravel、MySQL などのミドルウェアをアップグレードする際に発生する破壊的変更、非推奨機能、削除された機能を自動で収集し、既存コードベースへの影響を分析してレポートを生成します。

**特徴:**
- 複数のデータソース（GitHub公式ドキュメント、php.watch、ローカルTOML）から変更情報を収集
